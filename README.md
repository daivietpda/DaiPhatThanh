...
- Hỗ trợ PWA (Progressive Web App): có thể cài đặt lên màn hình chính, mở như ứng dụng riêng và hoạt động tốt hơn trên trình duyệt hỗ trợ.

## PWA (Progressive Web App)

Ứng dụng đã được cấu hình để hoạt động như một PWA:

- Có thể cài đặt trên thiết bị bằng trình duyệt hỗ trợ.
- Mở dưới dạng ứng dụng riêng thay vì chỉ là tab web thông thường.
- Sử dụng service worker để cải thiện hiệu năng và khả năng tải lại nhanh hơn.
- Được tối ưu cho trải nghiệm trên màn hình chính của điện thoại hoặc máy tính.

Để cài đặt, hãy mở trang web trong trình duyệt và chọn tùy chọn “Cài đặt ứng dụng” hoặc “Add to Home screen” hoặc “Thêm vào màn hình chính” nếu trình duyệt hiện tùy chọn này.
